...
module BattleManager
  ...
  #
  # 取得處於行動順序清單頂端的戰鬥者。
  # 沒有取得角色時（index 為 nil, 或是戰鬥事件在戰鬥後發生）則略過此行動。
  #
