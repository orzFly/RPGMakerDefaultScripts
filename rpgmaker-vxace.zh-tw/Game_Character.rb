...
class Game_Character < Game_CharacterBase
  ...
  #
  ROUTE_END               = 0             # 搬移路徑的終點
  ROUTE_MOVE_DOWN         = 1             # 向下搬移
  ROUTE_MOVE_LEFT         = 2             # 向左搬移
  ROUTE_MOVE_RIGHT        = 3             # 向右搬移
  ROUTE_MOVE_UP           = 4             # 向上搬移
  ROUTE_MOVE_LOWER_L      = 5             # 左下搬移
  ROUTE_MOVE_LOWER_R      = 6             # 右下搬移
  ROUTE_MOVE_UPPER_L      = 7             # 坐上搬移
  ROUTE_MOVE_UPPER_R      = 8             # 右上搬移
  ROUTE_MOVE_RANDOM       = 9             # 隨機搬移
  ROUTE_MOVE_TOWARD       = 10            # 接近玩家
  ROUTE_MOVE_AWAY         = 11            # 遠離玩家
  ROUTE_MOVE_FORWARD      = 12            # 前進一步
  ROUTE_MOVE_BACKWARD     = 13            # 後退一步
  ROUTE_JUMP              = 14            # 跳躍
  ROUTE_WAIT              = 15            # 等待
  ...
  ROUTE_CHANGE_SPEED      = 29            # 變更搬移速度
  ROUTE_CHANGE_FREQ       = 30            # 變更搬移頻度
  ...
  ROUTE_CHANGE_GRAPHIC    = 41            # 變更圖像
  ROUTE_CHANGE_OPACITY    = 42            # 變更不透明度
  ROUTE_CHANGE_BLENDING   = 43            # 變更合成模式
  ...
  #
  #
  attr_reader   :move_route_forcing       # 搬移路徑強制的標志
  #
  # 初始化公有成員變量
  #
  #
