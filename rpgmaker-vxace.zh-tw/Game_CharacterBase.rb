#encoding:utf-8
#
# 管理地圖人物的基本類。是所有地圖人物類的共通父類。擁有坐標、圖片等基本訊息。
#
...
class Game_CharacterBase
  ...
  attr_accessor :balloon_id               # 心情圖示 ID
